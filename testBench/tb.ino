...
// Function to be called by the ticker
void tickerCallback()
{
...
void setup()
{
    ...
    // Initialize ticker
    ticker.attach_ms(samplingInterval / 1000, tickerCallback);
...
void loop()
{
    // Nothing to do, everything is handled by the ticker and web server
}